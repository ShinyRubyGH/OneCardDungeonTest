export function getInitialTurnResources(player) {
    return {
        energyDice: [],
        assignedEnergy: {
            velocidad: null,
...
export function setRolledDice(player, dice) {
    return {
        energyDice: dice,
        assignedEnergy: {
            velocidad: null,
...
export function selectEnergyDie(turn, dieIndex) {
...
export function assignSelectedDieToStat(player, turn, stat) {
