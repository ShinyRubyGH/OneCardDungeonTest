import type { PlayerClassId } from './types.js';
...
export const PLAYER_CLASS_OPTIONS: PlayerClassOption[] = [
	{
		id: 'paladin',
		nombre: 'Paladin',
		titulo: 'Paladin',
...
export function getPlayerClassOption(id: PlayerClassId): PlayerClassOption {
